...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT first_name, last_name, address, email, request_type, created_at FROM service_requests WHERE user_id = ?";
    ...
    $stmt->bind_result($first_name, $last_name, $address, $email, $request_type, $created_at);
